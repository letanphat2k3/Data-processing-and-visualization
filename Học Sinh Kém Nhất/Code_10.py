...
data = pd.read_csv(r'D:\Bttlpython\ThuyetTrinh\danh_sach_thi_sinh_10_Lang_Son.csv')
...
print('Số học sinh có thành tích kém khối A00 là: ')
print(data_new[A < 15]['sbd'])
B = math + Chemictry + biology
print('Số học sinh có thành tích kém khối B00 là: ')
print(data_new[B < 15]['sbd'])
C = literature + History + Geography
print('Số học sinh có thành tích kém khối C00 là: ')
print(data_new[C < 15]['sbd'])
D = math + literature + English
print('Số học sinh có thành tích kém khối D00 là: ')
...
plt.title('Số học sinh có thành tích kém tỉnh Lạng Sơn(10)')
